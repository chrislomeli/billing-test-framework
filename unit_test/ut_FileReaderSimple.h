...
#include "f_FileRecordReader.h"
#include "c_ParserDelimited.h"
#include "c_ParserFixedLength.h"
#include "f_FileRecordReaderTester.h"

class ut_FileReaderSimple : public ut_UnitTest, public f_FileRecordReader
{
public:
	ut_FileReaderSimple(void);
	~ut_FileReaderSimple(void);

	f_FileRecordReaderTester tester;
