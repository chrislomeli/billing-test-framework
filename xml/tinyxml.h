/**
 * \file tinyxml.h
 * Header file containing classes XML formatting.
 *
 * $Id: tinyxml.h,v 1.1 2007/01/15 14:14:24 sathpv Exp $
 * $Source: /proj/cvs/untd_billing/server/tools/cpptools/xml/tinyxml.h,v $
 *********************************************************************************/
...
protected:
  ...
  */
  ...
  /**
   * Stores all the possible error codes.
   */
  enum
  {
    TIXML_NO_ERROR = 0,
