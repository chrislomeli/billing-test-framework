/**
 * \file tinystr.h
 * Header file containing TiXmlString which 
 * is an emulation of the std::string template.
 *
 * $Id: tinystr.h,v 1.1 2007/01/15 14:14:24 sathpv Exp $
 * $Source: /proj/cvs/untd_billing/server/tools/cpptools/xml/tinystr.h,v $
 *********************************************************************************/
...
class TiXmlString
{
  ...
  protected :
    ...
    /**
     * New size computation. It is simplistic right now : it returns 
     * twice the amount we need
     */ 
