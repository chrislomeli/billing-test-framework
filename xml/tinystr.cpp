/**
 * \file tinystr.cpp
 * Source file containing TiXmlString which
 * is an emulation of the std::string template.
 *
 * $Id: tinystr.cpp,v 1.1 2007/01/15 14:14:24 sathpv Exp $
 * $Source: /proj/cvs/untd_billing/server/tools/cpptools/xml/tinystr.cpp,v $
 *********************************************************************************/
...
static char *CVS_Id = (char *)"CVS_VERSION:$Id: tinystr.cpp,v 1.1 2007/01/15 14:14:24 sathpv Exp $";
static char *CVS_Source = (char *)"CVS_VERSION:$Source: /proj/cvs/untd_billing/server/tools/cpptools/xml/tinystr.cpp,v $";
...
/// searched for a particular string
...
/// Compares two TiXmlString for equality
